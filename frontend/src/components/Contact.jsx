		...
		const fetchServices =
			async () => {
				try {
					...
					// Set fallback services jika API gagal
					setServices(
						[
							{
								id_service: "web",
								title_services: "Web Development",
							},
							{
								id_service: "mobile",
								title_services: "Mobile App Development",
							},
							{
								id_service: "uiux",
								title_services: "UI/UX Design",
							},
							{
								id_service: "digital",
								title_services: "Digital Marketing",
							},
							{
								id_service: "security",
								title_services: "Cybersecurity",
							},
							{
								id_service: "cloud",
								title_services: "Cloud Solutions",
							},
						]
					);
				}
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			if (
				...
				toast.error(
					"Koneksi bermasalah. Pastikan server backend berjalan."
				);
			} else {
				// Other error
				console.error(
						...
						{contactMethods.map(
							(
								...
								>
									...
									<p
										className={`font-medium ${method.textColor}`}
									>
										{
											method.action
										}
