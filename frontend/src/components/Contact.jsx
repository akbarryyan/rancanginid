	...
	const contactMethods = [
		{
			...
			link:
				"mailto:hello@rancangin.com?subject=Inquiry%20from%20Website",
			bgColor:
		...
		},
		{
			...
			link:
				"https://wa.me/6281234567890?text=Halo%20Rancangin,%20saya%20tertarik%20dengan%20layanan%20Anda",
			bgColor:
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
				...
				>
					...
					<p className="text-lg text-secondary-600 dark:text-secondary-300 max-w-3xl mx-auto mb-12">
						Siap untuk memulai proyek digital Anda? Pilih cara yang paling nyaman
