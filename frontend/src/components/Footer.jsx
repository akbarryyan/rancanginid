					...
					<div>
						...
						<ul className="space-y-4">
							<ContactInfo
								...
								text="Jl. Siliwangi No. 123, Indonesia, 45213"
							/>
							<ContactInfo
								icon={
									<path
...
const SocialLink = ({ href, icon }) => (
	<a
		href={href}
		className="w-10 h-10 rounded-full bg-secondary-800 flex items-center justify-center text-secondary-300 hover:bg-primary-600 hover:text-white transition-colors"
	>
		<svg
			className="w-5 h-5"
			fill="currentColor"
...
const ContactInfo = ({ icon, text }) => (
	<li className="flex items-start">
		<svg
			...
			className="h-5 w-5 mr-3 text-primary-400 flex-shrink-0 mt-1"
			fill="none"
			viewBox="0 0 24 24"
			stroke="currentColor"
		>
