  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Eksplorasi tren teknologi terbaru yang akan membentuk lanskap bisnis digital di tahun 2024 dan cara memanfaatkannya.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Langkah-langkah praktis yang dapat diterapkan UKM untuk memulai perjalanan transformasi digital mereka.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Tips dan trik untuk meningkatkan kecepatan website dan performa SEO yang akan meningkatkan ranking di mesin pencari.",
      image:
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <p className="text-lg text-secondary-600 dark:text-secondary-300 max-w-3xl mx-auto">
            Temukan wawasan terbaru tentang teknologi, strategi digital, dan
            tips pengembangan bisnis dari para ahli kami.
          </p>
        </div>
