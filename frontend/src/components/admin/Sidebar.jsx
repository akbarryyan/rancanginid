...
const Sidebar = ({ isOpen, onToggle }) => {
  ...
  // Fetch jumlah pesan baru saat komponen dimuat
  useEffect(() => {
    ...
    const fetchNewMessagesCount = async () => {
      try {
        ...
        const newMessages = data.filter((message) => message.status === "new");
        setNewMessagesCount(newMessages.length);
      } catch (err) {
        console.error("Gagal mengambil jumlah pesan baru:", err);
      }
    };
  ...
  const menuItems = [
    ...
    },
    {
      ...
      path: "/back/messages",
      badge: newMessagesCount > 0 ? newMessagesCount.toString() : null,
    },
    {
      id: "orders",
      name: "Orders",
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-yellow-700 dark:text-yellow-300 mt-1">
                      Pastikan semua pekerjaan Anda telah disimpan sebelum
                      logout. Anda akan diarahkan ke halaman login setelah
                      logout.
                    </p>
                  </div>
                </div>
